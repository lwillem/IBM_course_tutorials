...
to setup
  ...
  if logging
  [
    ;; close all previous files... and create a new log file
    file-close-all
...
to setup-patches
  ...
  ask patches with [pxcor > -1 and pxcor < 9]
  [ set meaning "border"
   set pcolor gray - 4
  ]

  ask patches with [pycor < -8 and pycor > -16]
  [ set meaning "border"
   set pcolor gray - 4
  ]
...
to setup-people
  ...
  [
    ...
    [
     ...
     set loc_daytime min-one-of (schools) [ distance myself ]
    ]
...
to move  ;; people procedure
    ...
    if current-hour = hour-leave-home and ( day-of-week < 6 or daytypes = "weekdays" )  and daytypes != "weekend" and holiday? = false
      [
         if age >= age-adult or not school-closure
          [
            move-to loc_daytime
...
if current-hour = 24
  [
    ...
    if current-day = holiday-start
    [ set holiday? true ]

    if current-day = holiday-start + holiday-duration
    [ set holiday? false ]
  ]
...
@#$#@#$#@
<experiments>
  <experiment name="holidays" repetitions="10" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>count people with [recovered?]</metric>
    <metric>log-peak-day</metric>
    <metric>log-peak-prevalence</metric>
    <steppedValueSet variable="holiday-start" first="1" step="2" last="20"/>
    <enumeratedValueSet variable="school-closure">
      <value value="false"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="num-days">
      <value value="40"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="num-days-infected">
      <value value="6"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="daytypes">
      <value value="&quot;week/weekend&quot;"/>
    </enumeratedValueSet>
    ...
    <steppedValueSet variable="holiday-duration" first="1" step="2" last="14"/>
  </experiment>
  <experiment name="holidays-dayoutput" repetitions="10" runMetricsEveryStep="true">
    <setup>setup</setup>
    <go>go</go>
    <metric>count people with [recovered?]</metric>
    <metric>log-peak-day</metric>
  ...
  <experiment name="week-weekend" repetitions="5" runMetricsEveryStep="false">
    <setup>setup</setup>
    <go>go</go>
    <metric>count people with [recovered?]</metric>
    <metric>log-peak-day</metric>
    <metric>log-peak-prevalence</metric>
    <enumeratedValueSet variable="holiday-start">
      <value value="40"/>
    </enumeratedValueSet>
    <enumeratedValueSet variable="school-closure">
      <value value="false"/>
    ...
    <enumeratedValueSet variable="holiday-duration">
      <value value="0"/>
    </enumeratedValueSet>
  </experiment>
</experiments>
